...
| 400 | `MISSING_INPUT` | Either html, url, or templateId is required |
| 400 | `CONFLICTING_INPUT` | Only one of html, url, or templateId allowed |
...
| 404 | `TEMPLATE_NOT_FOUND` | Template not found or not accessible |
| 429 | `QUOTA_EXCEEDED` | Monthly render quota exceeded |
| 429 | `QUEUE_FULL` | Server render queue is at capacity |
